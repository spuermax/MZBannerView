...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private void initAdapter() {
        mAdapter = new MZPagerAdapter(null, null, mIsCanLoop);
    }
    ...
    public void setBannerPageClickListener(BannerPageClickListener bannerPageClickListener) {
        if (mAdapter != null) {
            mAdapter.setPageClickListener(bannerPageClickListener);
        }
    ...
    public BannerPageClickListener getBannerPageClickListener() {
        return mBannerPageClickListener;
    }
    ...
    public void setPages(List<T> datas, MZHolderCreator mzHolderCreator) {
        ...
        if (mAdapter != null) {
            ...
            mAdapter.setMZHolderCreator(mzHolderCreator);
    ...
    public static class MZPagerAdapter<T> extends PagerAdapter {
        ...
        public void setMZHolderCreator(MZHolderCreator mMZHolderCreator) {
            this.mMZHolderCreator = mMZHolderCreator;
        }
        ...
        public BannerPageClickListener getPageClickListener() {
            return mPageClickListener;
        }
        ...
        private View getView(int position, ViewGroup container) {
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (getPageClickListener() != null) {
                        getPageClickListener().onPageClick(v, realPosition);
                    }
                }
            });
